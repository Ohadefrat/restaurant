    ...
    <Card sx={{ backgroundColor: "#00000060" }}>
      <CardContent sx={{ color: 'white' }}>
        <Grid container alignItems="center" spacing={1}>
          <Grid item>
            <Avatar src={logo} alt={`${name} logo`} sx={{
          ...
          <Grid item>
            <Typography variant="body1" sx={{ fontFamily: raleway.style }}>{name}</Typography>
          </Grid>
        </Grid>
      </CardContent>
    </Card>
...
const TechStack = () => {
  ...
  return (
    <Container>
      <Box padding={2}>
        <Typography variant="h6" gutterBottom color="white" sx={{ fontFamily: raleway.style }}>
